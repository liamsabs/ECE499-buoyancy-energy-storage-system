...
def relay_control_loop():

    while True:
        if control_panel.is_new_load_command_available():
...
# begin checking load switch and updating load relay
_thread.start_new_thread(relay_control_loop, ())
